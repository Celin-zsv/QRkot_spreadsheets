...
Revision ID: 90560bf8cfac
Revises: 
Create Date: 2023-06-30 21:02:37.079319
...
def upgrade():
    ...
    sa.CheckConstraint('full_amount > 0', name='ch_full_amount_positive'),
    sa.CheckConstraint('full_amount >= invested_amount', name='ch_full_amount_ge_invested_amount'),
